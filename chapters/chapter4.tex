...
This task focuses on the implementation of the individual architectural components specified in \ac{wp}2 Task 2.1 as functional prototypes, validating and testing the slice mobility and inter-domain federation mechanisms before integration into a consolidated framework. These prototypes will use \ac{etsi} OpenOP as a baseline, due to it being the most complete implementation of an \ac{op} up to date.
