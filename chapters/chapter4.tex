...
\section{WP0: Course Enrolment}

\ac{wp}0 encompasses tasks relating to mandatory activities of the doctoral program, which are as follows:

\subsection{Task 0.1 - Curricular Classes}
...
\subsection{Task 0.2 - Thesis Proposal}
...
\subsection{Task 0.3 - Progress Reports}

This task covers the annual progress reports stating the developments made over the the respective year of research, identifying if the proposed milestones are being accomplished and possible adjustments to the research and development plans. 

\subsection{Task 0.4 - Final Thesis}
...
\ac{wp}5 encompasses continuous dissemination activities, covering scientific publication of research contributions and open-source release of all developed components.
...
\subsection{Task 5.2 - Open-Source Releases}
