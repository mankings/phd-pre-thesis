...
%%% Edit author's name
%% Author's full name
\Author{João Miguel}{Almeida Matos}
% \Orcid{0009-0001-9669-4566}

%%% Edit thesis title in Portuguese
%% Thesis Mandatory Title in Portuguese
\TitlePT{Federação Dinâmica de Redes e Fatiamento na Borda}
...
\TitleEN{Dynamic Network Federation and Edge Slicing}
...
\Supervisor{Daniel Corujo}{associado c/ agregação}
...
\SupervisorMember{Rui Aguiar}{catedrático}{do Departamento de Eletrónica, Telecomunicações e Informática}{da Universidade de Aveiro}{}
...
\Degree{Doutor}{Engenharia Informática}
...
% \GrantText{Bolsa de Doutoramento no âmbito do projeto Europeu 6G-VERSUS (referência a confirmar), bolsa em ambiente académico.}{}

%%% Edit the Jury President information.
%% First Member will be the President of the Jury
\JuriMember{Prof. Augusto Silva}{professor associado na Universidade de Aveiro}

%%% Repeat the above declaration for additional
%%%  members of the jury as many times as necessary.
%% Additional members of the Jury
\JuriMember{Prof. David Perez Abreu}{professor auxiliar na Universidade de Coimbra}
\JuriMember{Prof. Francisco Fontes}{professor auxiliar convidado na Universidade de Aveiro}
\JuriMember{Prof. Daniel Corujo}{professor associado c/ agregação na Universidade de Aveiro}

%%% OPTIONAL: Add an acknowledgement text
%% Optional Acknowledgement text
\Acknowledgements{Um sincero obrigado a todos que me aturam e inspiram, quer em regime presencial, remoto ou híbrido.
}
...
\bibliography{bib/standards.bib}
